...
const questions = [
  ...
  { id: 10, question: "Why is a single-cycle CPU useful for learning about instruction execution?", options: ["It is the fastest type of CPU", "It is easy to debug since all instructions complete in one cycle", "It uses advanced parallel processing", "It does not require a control unit"], correctAnswer: "It is easy to debug since instructions complete in one cycle" },
];
